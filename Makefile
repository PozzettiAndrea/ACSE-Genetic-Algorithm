...
$(BIN_DIR)/Genetic_Algorithm: $(BUILD_DIR)/Genetic_Algorithm.o $(BUILD_DIR)/CUnit.o $(BUILD_DIR)/CCircuit.o $(BUILD_DIR)/main.o 
...
$(TEST_BIN_DIR)/test1: $(TEST_BUILD_DIR)/test1.o $(BUILD_DIR)/CUnit.o $(BUILD_DIR)/CCircuit.o
	$(CXX) -o $@ $^ $(CXXFLAGS) $(CPPFLAGS) $(LDFLAGS)

$(TEST_BIN_DIR)/test2: $(TEST_BUILD_DIR)/test2.o $(BUILD_DIR)/CUnit.o $(BUILD_DIR)/CCircuit.o $(BUILD_DIR)/Genetic_Algorithm.o
	$(CXX) -o $@ $^ $(CXXFLAGS) $(CPPFLAGS) $(LDFLAGS)

$(TEST_BIN_DIR)/test3: $(TEST_BUILD_DIR)/test3.o $(BUILD_DIR)/CUnit.o $(BUILD_DIR)/CCircuit.o $(BUILD_DIR)/Genetic_Algorithm.o
	$(CXX) -o $@ $^ $(CXXFLAGS) $(CPPFLAGS) $(LDFLAGS)
